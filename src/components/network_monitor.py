    ...
    try:
        ...
        with col3:
            if auto_refresh:
                ...
                if 'network_monitor_last_refresh' not in st.session_state:
                    st.session_state.network_monitor_last_refresh = datetime.now()
                
                time_since_refresh = (datetime.now() - st.session_state.network_monitor_last_refresh).total_seconds()
